...
angular.module('AngularForceObjectFactory', []).factory('AngularForceObjectFactory', function (SFConfig, AngularForce) {
    function AngularForceObjectFactory(params) {
        ...
        /*RSC And who doesn't love Apexrest*/
        AngularForceObject.apexrest = function (path, successCB, failureCB, method, payload, paramMap, retry) {
            //function(path, callback, error, method, payload, paramMap, retry)
            return SFConfig.client.apexrest(path, successCB, failureCB, method, payload, paramMap, retry);
            //return Force.reidForcetkClient.apexrest(path, successCB, failureCB, method, payload, paramMap, retry);
        };
        ...
        AngularForceObject.save = function (obj, successCB, failureCB) {
            ...
            logToConsole("here we are in save");
